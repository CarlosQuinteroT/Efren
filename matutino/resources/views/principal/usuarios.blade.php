                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="email" id="clave" name="clave" class="form-control" placeholder="Clave">
                                    </div>
                                </div>
                              <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="email-input">Condicion</label>
                                    <div class="col-md-9">
                                        <input type="email" id="condicion" name="condicion" class="form-control" placeholder="Condicion">
                                    </div>
                                </div>
